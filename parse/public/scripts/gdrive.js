define(['q'], function($q) {
    ...
    //var clientId = '461007973312-4vftdrkaig4vmv8vd3b2e1o6qgj76eqt.apps.googleusercontent.com'; //prod
    ...
    function getFiles(folderId) {
        ...
        if ( folderCache[folderId] ){
            deferred.resolve(folderCache[folderId]);
        } 
        
        getFromServer(folderId).then(function(result){
    ...
    function getFromServer(folderId){
        var deferred = $q.defer();
